        ...
        <section class="main">
            ...
            <form name='login' method='post'>
                ...
                <div class="submit-container">
                    <div class="remember">
                        <input type='checkbox' checked name='remember' value="1" <?php if(isset($_POST["remember"])){echo $_POST["remember"] ? "checked" : "";} ?>>
            ...
            <div class="signup-btn-container"><a class="signup-btn" href="signup.php">ISCRIVITI A MUSITY</a></div>
        </section>
        </main>
    </body>
</html>